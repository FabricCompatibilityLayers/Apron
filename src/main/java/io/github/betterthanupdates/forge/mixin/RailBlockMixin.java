...
public abstract class RailBlockMixin extends Block {
    @Shadow @Final private boolean field_1262;

    @Shadow protected abstract boolean method_1103(World arg, int i, int j, int k, int l, boolean bl, int m);

    @Shadow protected abstract void method_1104(World arg, int i, int j, int k, boolean bl);
