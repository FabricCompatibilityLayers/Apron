...
public abstract class WorldMixin implements BlockView, ForgeWorld {
    ...
    @Shadow public abstract int method_164(LightType arg, int i, int j, int k);

    @Shadow public abstract void method_166(LightType arg, int i, int j, int k, int l, int m, int n);

    @Shadow public abstract boolean method_155(int i, int j, int k, int l, int m, int n);

    @Shadow private boolean field_190;
    ...
    @Shadow public abstract boolean canSpawnEntity(Box arg);
