...
public class SAPI {
	...
	public static boolean interceptHarvest(World world, PlayerEntity player, BlockPos pos, int i, int j) {
	...
	public static void drop(World world, BlockPos blockPos, ItemStack stack) {
		...
		for (int i = 0; i < stack.count; i++) {
			...
			ItemEntity itemEntity = new ItemEntity(world,
					(double)blockPos.x + d,
					(double)blockPos.y + d1,
					(double)blockPos.z + d2, new ItemStack(stack.itemId, 1,
					stack.getDamage()));
	...
	public static int interceptBlockSet(World world, BlockPos pos, int meta) {
