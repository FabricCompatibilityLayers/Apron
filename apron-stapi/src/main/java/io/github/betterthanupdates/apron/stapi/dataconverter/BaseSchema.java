...
import io.github.betterthanupdates.apron.stapi.mixin.SchemaAccessor;
...
public class BaseSchema extends Schema {
    ...
    public BaseSchema(int versionKey, ModDatabase database, Schema parent) {
		...
		((SchemaAccessor) this).setTYPES(buildTypes());
    }
    ...
    public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> entityTypes, Map<String, Supplier<TypeTemplate>> blockEntityTypes) {
		((SchemaAccessor)this).getTYPE_TEMPLATES().clear();
		RECURSIVE_TYPES.clear();
		schema.registerType(
				false,
